...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function a(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var n=e.scrollTo=function(t,a,n){return e(window).scrollTo(t,a,n)};return n.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(i,o,r){"object"==typeof o&&(r=o,o=0),"function"==typeof r&&(r={onAfter:r}),"max"===i&&(i=9e9),r=e.extend({},n.defaults,r),o=o||r.duration;var s=r.queue&&r.axis.length>1;return s&&(o/=2),r.offset=a(r.offset),r.over=a(r.over),this.each(function(){function l(t){var a=e.extend({},r,{queue:!0,duration:o,complete:t&&function(){t.call(d,f,r)}});p.animate(h,a)}if(null!==i){var c,u=t(this),d=u?this.contentWindow||window:this,p=e(d),f=i,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=a(f);break}if(f=u?e(f):e(f,d),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(r.offset)&&r.offset(d,f)||r.offset;e.each(r.axis.split(""),function(e,t){var a="x"===t?"Left":"Top",i=a.toLowerCase(),o="scroll"+a,v=p[o](),g=n.max(d,t);if(c)h[o]=c[i]+(u?0:v-p.offset()[i]),r.margin&&(h[o]-=parseInt(f.css("margin"+a),10)||0,h[o]-=parseInt(f.css("border"+a+"Width"),10)||0),h[o]+=m[i]||0,r.over[i]&&(h[o]+=f["x"===t?"width":"height"]()*r.over[i]);else{var $=f[i];h[o]=$.slice&&"%"===$.slice(-1)?parseFloat($)/100*g:$}r.limit&&/^\d+$/.test(h[o])&&(h[o]=h[o]<=0?0:Math.min(h[o],g)),!e&&r.axis.length>1&&(v===h[o]?h={}:s&&(l(r.onAfterFirst),h={}))}),l(r.onAfter)}})},n.max=function(a,n){var i="x"===n?"Width":"Height",o="scroll"+i;if(!t(a))return a[o]-e(a)[i.toLowerCase()]();var r="client"+i,s=a.ownerDocument||a.document,l=s.documentElement,c=s.body;return Math.max(l[o],c[o])-Math.min(l[r],c[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var a=this.get(t);if(t.options.interrupt&&t._last&&t._last!==a)return e(t.elem).stop();var n=Math.round(t.now);a!==n&&(e(t.elem)[t.prop](n),t._last=this.get(t))}},n});
!function(e,t){"$:nomunge";var a,n=e.jQuery||e.Cowboy||(e.Cowboy={});n.throttle=a=function(e,a,i,o){function r(){function n(){l=+new Date,i.apply(c,d)}function r(){s=t}var c=this,u=+new Date-l,d=arguments;o&&!s&&n(),s&&clearTimeout(s),o===t&&u>e?n():a!==!0&&(s=setTimeout(o?r:n,o===t?e-u:e))}var s,l=0;return"boolean"!=typeof a&&(o=i,i=a,a=t),n.guid&&(r.guid=i.guid=i.guid||n.guid++),r},n.debounce=function(e,n,i){return i===t?a(e,n,!1):a(e,i,n!==!1)}}(this);
/*!
...
var unikat=function(){"use strict";function e(){if(h='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+m.loadingImageSrc+'" alt="'+m.loadingImageAlt+'" title="'+m.loadingImageTitle+'">'+m.loadingText+"</div></div></div>",b=m.ajaxErrorMessage+b,placeholder(),!m.is_auth){window.history.location||window.location;if($(window).on("popstate",function(e){var t=$(".sidebar"),a=$(".sidebar-tabs li"),n=window.location.hash,i=n?t.index($(n)):0,o=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),a.removeClass("sidebar-tab-active"),t.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),a.eq(i).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:m.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var a=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:a?a.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),a=$(".sidebar-tabs li"),n=$(".sidebar"),i=a.index(t);a.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),n.removeClass("sidebar-active"),n.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var o=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("body").on("click",v,function(e){e.preventDefault();var t=$(this).data("table"),a=-1==$(this).attr("href").indexOf("?")?"?":"&",n=$(this).attr("href")+(t?a+"table="+t:"");$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:m.magnificPopupClose,tLoading:m.magnificPopupLoading,ajax:{tError:m.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:n}})}),m.datatables){$.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,defaultContent:"",language:{url:m.datatablesLanguage},rowCallback:function(e,t){-1!==$.inArray(t.DT_RowId,a)&&$(e).addClass("selected")}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})});var e=".dataTables_filter";$(document).on("preInit.dt",function(t,a){$(e+" input").off("keyup.DT input.DT")}),$(document).on("input keyup",e+" input",$.debounce(m.datatablesSearchDelay,function(t){var a=$(this).parents(e).attr("id").replace("_filter",""),n=m.tables[a];n.search(this.value).draw()}));var a=[];$(document).on("click",".dataTable tbody tr",function(){var e=$(this).parents("table").attr("id"),t=(m.tables[e],this.id),n=$.inArray(t,a);-1===n?a.push(t):a.splice(n,1),$(this).toggleClass("selected")})}}$(document).on("click",function(e){$(e.target).closest(".submenu").length||($(".dropdown-menu").each(function(){$(this).hasClass("menu-static")||$(this).removeClass("active")}),$(".slidedown-menu").each(function(){$(this).hasClass("menu-static")||$(this).slideUp()}))}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault(),$(this).toggleClass("active");var t=$(this).next();$(".dropdown-menu.active").not(t[0]).removeClass("active"),t.toggleClass("active")}),$(document).on("click",".slidedown-toggle",function(e){e.preventDefault(),$(e.target).closest(".dropdown-menu").length||$(".dropdown-menu.active").removeClass("active"),$(this).toggleClass("active"),$(this).next().slideToggle()}),$(document).on("click",P+" "+J,function(){$(this).closest(P).remove()}),"function"==typeof this.callback&&this.callback(),$(document).on("submit","form",function(e){return e.preventDefault(),t({that:$(this),method:"post",queue:$(this).data("ajaxQueue"),action:$(this).attr("action"),data:$(this).serialize()}),!1}),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:m.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e){var t=$.Deferred();if(o(e.that),n(e.that),"get"==e.method)var a=$.getq(e.queue,e.action,e.data);else var a=$.postq(e.queue,e.action,e.data);return a.done(function(a,n,o){$.each(a,function(e){if("object"==typeof a[e]){if(a[e].updateTable){var n=m.tables["datatable"+e];a[e].ajax&&"function"==typeof n.ajax.url()?n.clearPipeline().draw(!1):a[e].data&&n.clear().rows.add(a[e].data).draw()}a[e].reloadTable&&(a[e].table=e,t.resolve(a[e]))}}),a.redirect?window.location.href=a.redirect:(i(e.that),c(e.that,a),a.success?p(e.that,a.success):a.errors&&u(e.that,a.errors))}),a.fail(function(t,a,n){"abort"!=a&&(i(e.that),422==t.status?l(e.that,t.responseJSON):d(e.that,a+": "+n))}),t.promise()}function a(e,t,a){var n=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),i=e.find("input:radio, input:checkbox");a?(n.each(function(){$(this).is(a)&&$(this).val("")}),i.each(function(){$(this).is(a)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(n.not(t).val(""),i.not(t).removeAttr("checked").removeAttr("selected")):(n.val(""),i.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),e.lock_timer=window.setTimeout(function(){$(h).prependTo(e.closest(I)).focus(),$(N,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var a=t.keyCode?t.keyCode:t.which;return 27==a&&i(e),!1})},F),!0}function i(e){return window.clearTimeout(e.lock_timer),e.prev(P).empty(),$("[type=submit]",e).prop("disabled",!1),$(N,e).remove(),!0}function o(e){/^sync-/.test(e.data("ajaxQueue"))&&$.ajaxq.isRunning(e.data("ajaxQueue"))&&$.ajaxq.abort(e.data("ajaxQueue"))}function r(e,t){var a=e.prev(P);a.length>0?a.append(t):($(q+t+T).insertBefore(e),a=e.prev(P)),isElementInViewport(a[0])||$.scrollTo(a[0])}function s(e){$(A,e).remove(),$(D,e).removeClass(Q)}function l(e,t){s(e);var a="";if("object"==typeof t){a+=g+b;for(var n in t){$("#input-"+n).next().hasClass(R)?$("#input-"+n).after(O).closest(D).addClass(Q):$("#input-"+n).closest(D).addClass(E).append(O);for(var i=0;i<t[n].length;i++)a+=y+S+t[n][i]+x}a+=w+C}r(e,a)}function c(e,t){var n=[],i=[];if(t.resetOnly){for(var o=0;o<t.resetOnly.length;o++)i.push("#input-"+t.resetOnly[o]);i.length&&a(e,null,i.join())}else if(t.resetExcept){for(var o=0;o<t.resetExcept.length;o++)n.push("#input-"+t.resetExcept[o]);n.length&&a(e,n.join())}else t.reset&&a(e)}function u(e,t){s(e);var a="";if("object"==typeof t){if(t.errors){a+=g+b;for(var n=0;n<t.errors.length;n++)a+=y+S+t.errors[n]+x;a+=w+C}if(t.ids)for(var n=0;n<t.ids.length;n++)$("#input-"+t.ids[n]).next().hasClass(R)?$("#input-"+t.ids[n]).after(O).closest(D).addClass(Q):$("#input-"+t.ids[n]).closest(D).addClass(E).append(O)}r(e,a)}function d(e,t){s(e),t=g+S+t+C,r(e,t)}function p(e,t){s(e),t=j+t+k,r(e,t)}function f(e){var e=$.extend({pipeline:m.datatablesPipeline,url:"",data:null,method:"get"},e),a=-1,n=null,i=null,o=null;return function(r,s,l){var c=!1,u=r.start,d=r.start,p=r.length;0>p&&(p=0);var f=u+p;if(l.clearCache?(c=!0,l.clearCache=!1):0==p||0>a||a>u||f>n?c=!0:(JSON.stringify(r.order)!==JSON.stringify(i.order)||JSON.stringify(r.columns)!==JSON.stringify(i.columns)||JSON.stringify(r.search)!==JSON.stringify(i.search))&&(c=!0),i=$.extend(!0,{},r),c){if(a>u&&(u-=p*(e.pipeline-1),0>u&&(u=0)),a=u,n=u+p*e.pipeline,r.start=u,r.length=p*e.pipeline,$.isFunction(e.data)){var h=e.data(r);h&&$.extend(r,h)}else $.isPlainObject(e.data)&&$.extend(r,e.data);var m=$(this).closest(I),v=t({that:m,method:e.method,queue:m.data("ajaxQueue"),action:e.url,data:r});v.done(function(e){o=$.extend(!0,{},e),a!=d&&e.data.splice(0,d-a),p>0&&e.data.splice(p,e.data.length),e.search&&$("#datatable"+e.table+"_filter input").focus(),s(e)})}else{var g=$.extend(!0,{},o);g.draw=r.draw,g.data.splice(0,u-a),p>0&&g.data.splice(p,g.data.length),s(g)}}}var h,m={tables:[]},v=".js-create",g='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',b="<ul>",y="<li>",x="</li>",w="</ul>",C="</div>",j='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',k="</div>",q='<div class="alert-messages">',T="</div>",S='<span class="glyphicon glyphicon-warning-sign"></span>',O='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',A="span.glyphicon-remove",D=".form-group",E="has-error has-feedback",Q=E+" has-addon-feedback",I=".ajax-lock",N=".ajax-locked",P=".alert-messages",R="input-group-addon",J="button.close",F=0;return{run:e,variables:m,datatables:f}}();
