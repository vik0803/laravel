...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function a(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var n=e.scrollTo=function(t,a,n){return e(window).scrollTo(t,a,n)};return n.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(o,i,r){"object"==typeof i&&(r=i,i=0),"function"==typeof r&&(r={onAfter:r}),"max"===o&&(o=9e9),r=e.extend({},n.defaults,r),i=i||r.duration;var s=r.queue&&r.axis.length>1;return s&&(i/=2),r.offset=a(r.offset),r.over=a(r.over),this.each(function(){function l(t){var a=e.extend({},r,{queue:!0,duration:i,complete:t&&function(){t.call(u,f,r)}});p.animate(h,a)}if(null!==o){var c,d=t(this),u=d?this.contentWindow||window:this,p=e(u),f=o,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=a(f);break}if(f=d?e(f):e(f,u),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(r.offset)&&r.offset(u,f)||r.offset;e.each(r.axis.split(""),function(e,t){var a="x"===t?"Left":"Top",o=a.toLowerCase(),i="scroll"+a,v=p[i](),g=n.max(u,t);if(c)h[i]=c[o]+(d?0:v-p.offset()[o]),r.margin&&(h[i]-=parseInt(f.css("margin"+a),10)||0,h[i]-=parseInt(f.css("border"+a+"Width"),10)||0),h[i]+=m[o]||0,r.over[o]&&(h[i]+=f["x"===t?"width":"height"]()*r.over[o]);else{var b=f[o];h[i]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*g:b}r.limit&&/^\d+$/.test(h[i])&&(h[i]=h[i]<=0?0:Math.min(h[i],g)),!e&&r.axis.length>1&&(v===h[i]?h={}:s&&(l(r.onAfterFirst),h={}))}),l(r.onAfter)}})},n.max=function(a,n){var o="x"===n?"Width":"Height",i="scroll"+o;if(!t(a))return a[i]-e(a)[o.toLowerCase()]();var r="client"+o,s=a.ownerDocument||a.document,l=s.documentElement,c=s.body;return Math.max(l[i],c[i])-Math.min(l[r],c[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var a=this.get(t);if(t.options.interrupt&&t._last&&t._last!==a)return e(t.elem).stop();var n=Math.round(t.now);a!==n&&(e(t.elem)[t.prop](n),t._last=this.get(t))}},n});
!function(e,t){"$:nomunge";var a,n=e.jQuery||e.Cowboy||(e.Cowboy={});n.throttle=a=function(e,a,o,i){function r(){function n(){l=+new Date,o.apply(c,u)}function r(){s=t}var c=this,d=+new Date-l,u=arguments;i&&!s&&n(),s&&clearTimeout(s),i===t&&d>e?n():a!==!0&&(s=setTimeout(i?r:n,i===t?e-d:e))}var s,l=0;return"boolean"!=typeof a&&(i=o,o=a,a=t),n.guid&&(r.guid=o.guid=o.guid||n.guid++),r},n.debounce=function(e,n,o){return o===t?a(e,n,!1):a(e,o,n!==!1)}}(this);
/*!
...
var unikat=function(){"use strict";function e(){if(u='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+m.loadingImageSrc+'" alt="'+m.loadingImageAlt+'" title="'+m.loadingImageTitle+'">'+m.loadingText+"</div></div></div>",b=m.ajaxErrorMessage+b,placeholder(),!m.is_auth){window.history.location||window.location;$(window).on("popstate",function(e){var t=$(".sidebar"),a=$(".sidebar-tabs li"),n=window.location.hash,i=n?t.index($(n)):0,o=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),a.removeClass("sidebar-tab-active"),t.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),a.eq(i).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:m.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var a=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:a?a.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),a=$(".sidebar-tabs li"),n=$(".sidebar"),i=a.index(t);a.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),n.removeClass("sidebar-active"),n.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var o=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("body").on("click",v,function(e){e.preventDefault();var t=$(this).attr("href");$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:m.magnificPopupClose,tLoading:m.magnificPopupLoading,ajax:{tError:m.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:t}})}),m.datatables&&($.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",paging:m.datatablesCount<=10?!1:!0,stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,defaultContent:"",searchDelay:m.datatablesAjax?400:0,serverSide:m.datatablesAjax?!0:!1,pagingType:m.datatablesPagingType,pageLength:m.datatablesPageLength,lengthMenu:m.datatablesLengthMenu,language:{url:m.datatablesLanguage},initComplete:function(e,t){var a=$("div.dataTables_filter input");a.off("keyup.DT input.DT");var n=$(".dataTable").DataTable();$(document).on("input keyup",a.selector,$.debounce(e.searchDelay,function(e){n.search(this.value).draw()}))}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}))}$(document).on("click",function(e){$(e.target).closest(".submenu").length||($(".dropdown-menu").each(function(){$(this).hasClass("menu-static")||$(this).removeClass("active")}),$(".slidedown-menu").each(function(){$(this).hasClass("menu-static")||$(this).slideUp()}))}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault(),$(this).toggleClass("active");var t=$(this).next();$(".dropdown-menu.active").not(t[0]).removeClass("active"),t.toggleClass("active")}),$(document).on("click",".slidedown-toggle",function(e){e.preventDefault(),$(e.target).closest(".dropdown-menu").length||$(".dropdown-menu.active").removeClass("active"),$(this).toggleClass("active"),$(this).next().slideToggle()}),$(document).on("click",P+" "+R,function(){$(this).closest(P).remove()}),"function"==typeof this.callback&&this.callback(),$(document).on("submit","form",function(e){e.preventDefault();var i=$(this);return"undefined"!=typeof f&&n(i),a(i),f=$.post(i.attr("action"),i.serialize()),f.done(function(e,a,o){if(e.reloadTable){var r=$(".dataTable").DataTable();e.ajaxURL?"function"==typeof r.ajax.url()?r.clearPipeline().draw(!1):r.ajax.url(e.ajaxURL).load():r.clear().rows.add(e.data).draw()}e.redirect?window.location.href=e.redirect:(n(i),e.success?(c(i,e.success),t(i)):s(i,e))}),f.fail(function(e,t,a){n(i),422==e.status?r(i,e.responseJSON):l(i,t+": "+a)}),!1}),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:m.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e,t,a){var n=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),i=e.find("input:radio, input:checkbox");a?(n.each(function(){$(this).is(a)&&$(this).val("")}),i.each(function(){$(this).is(a)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(n.not(t).val(""),i.not(t).removeAttr("checked").removeAttr("selected")):(n.val(""),i.removeAttr("checked").removeAttr("selected"))}function a(e,t){return t=t||!1,$("[type=submit]",e).prop("disabled",!0),p=window.setTimeout(function(){$(u).prependTo(e.closest(L)).focus(),$(J,e).on("keydown",function(a){a.preventDefault(),a.stopPropagation();var i=a.keyCode?a.keyCode:a.which;return 27==i&&n(e,t),!1})},M),!0}function n(e,t){return t=t||!1,"undefined"!=typeof f&&f.abort(),t&&"undefined"!=typeof h&&h.abort(),window.clearTimeout(p),e.prev(P).empty(),$("[type=submit]",e).prop("disabled",!1),$(J,e).remove(),!0}function i(e,t){var a=e.prev(P);a.length>0?a.append(t):($(T+t+S).insertBefore(e),a=e.prev(P)),isElementInViewport(a[0])||$.scrollTo(a[0])}function o(e){$(O,e).remove(),$(A,e).removeClass(I)}function r(e,t){o(e);var a="";if("object"==typeof t){a+=g+b;for(var n in t){$("#input-"+n).next().hasClass(F)?$("#input-"+n).after(E).closest(A).addClass(I):$("#input-"+n).closest(A).addClass(N).append(E);for(var r=0;r<t[n].length;r++)a+=y+D+t[n][r]+x}a+=C+w}i(e,a)}function s(e,a){o(e);var n="",r=[],s=[];if("object"==typeof a){if(a.errors){n+=g+b;for(var l=0;l<a.errors.length;l++)n+=y+D+a.errors[l]+x;n+=C+w}if(a.ids)for(var l=0;l<a.ids.length;l++)$("#input-"+a.ids[l]).next().hasClass(F)?$("#input-"+a.ids[l]).after(E).closest(A).addClass(I):$("#input-"+a.ids[l]).closest(A).addClass(N).append(E);if(a.resetOnly){for(var l=0;l<a.resetOnly.length;l++)s.push("#input-"+a.resetOnly[l]);s.length&&t(e,null,s.join())}else if(a.resetExcept){for(var l=0;l<a.resetExcept.length;l++)r.push("#input-"+a.resetExcept[l]);r.length&&t(e,r.join())}else a.reset&&t(e)}i(e,n)}function l(e,t){o(e),t=g+D+t+w,i(e,t)}function c(e,t){o(e),t=k+t+j,i(e,t)}function d(e){var e=$.extend({pipeline:m.datatablesPipeline,url:"",data:null,method:"GET"},e),i=-1,o=null,d=null,u=null;return function(p,f,m){var v=$(".dataTable").DataTable(),g=!1,b=p.start,y=p.start,x=p.length;0>x&&(x=v.page.len());var C=b+x;if(m.clearCache?(g=!0,m.clearCache=!1):0>i||i>b||C>o?g=!0:(JSON.stringify(p.order)!==JSON.stringify(d.order)||JSON.stringify(p.columns)!==JSON.stringify(d.columns)||JSON.stringify(p.search)!==JSON.stringify(d.search))&&(g=!0),d=$.extend(!0,{},p),g){if(i>b&&(b-=x*(e.pipeline-1),0>b&&(b=0)),i=b,o=b+x*e.pipeline,p.start=b,p.length=x*e.pipeline,$.isFunction(e.data)){var w=e.data(p);w&&$.extend(p,w)}else $.isPlainObject(e.data)&&$.extend(p,e.data);var k=$(this).closest(L);"undefined"!=typeof h&&n(k,!0),a(k,!0),h="GET"==e.method?$.get(e.url,p):$.post(e.url,p),h.done(function(e,a,o){e.redirect?window.location.href=e.redirect:(n(k,!0),e.success?(c(k,e.success),t(k)):e.errors?s(k,e):(u=$.extend(!0,{},e),i!=y&&e.data.splice(0,y-i),e.data.splice(x,e.data.length),e.search&&$("div.dataTables_filter input").focus(),f(e)))}),h.fail(function(e,t,a){n(k,!0),422==e.status?r(k,e.responseJSON):l(k,t+": "+a)})}else{var j=$.extend(!0,{},u);j.draw=p.draw,j.data.splice(0,b-i),j.data.splice(x,j.data.length),f(j)}}}var u,p,f,h,m={},v=".js-create",g='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',b="<ul>",y="<li>",x="</li>",C="</ul>",w="</div>",k='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',j="</div>",T='<div class="alert-messages">',S="</div>",D='<span class="glyphicon glyphicon-warning-sign"></span>',E='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',O="span.glyphicon-remove",A=".form-group",N="has-error has-feedback",I=N+" has-addon-feedback",L=".ajax-lock",J=".ajax-locked",P=".alert-messages",F="input-group-addon",R="button.close",M=0;return{datatables:d,run:e,variables:m}}();
