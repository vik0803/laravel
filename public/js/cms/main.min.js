...
var unikat=function(){"use strict";function e(){if(v='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+g.loadingImageSrc+'" alt="'+g.loadingImageAlt+'" title="'+g.loadingImageTitle+'">'+g.loadingText+"</div></div></div>",x=g.ajaxErrorMessage+x,placeholder(),!g.is_auth){window.history.location||window.location;if($(window).on("popstate",function(e){var t=$(".sidebar"),a=$(".sidebar-tabs li"),n=window.location.hash,i=n?t.index($(n)):0,o=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),a.removeClass("sidebar-tab-active"),t.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),a.eq(i).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:g.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var a=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:a?a.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),a=$(".sidebar-tabs li"),n=$(".sidebar"),i=a.index(t);a.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),n.removeClass("sidebar-active"),n.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var o=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("body").on("click",b,function(e){e.preventDefault();var t=$(this).data("table"),a=-1==$(this).attr("href").indexOf("?")?"?":"&",n=$(this).attr("href")+(t?a+"table="+t:"");$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:g.magnificPopupClose,tLoading:g.magnificPopupLoading,ajax:{tError:g.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:n}})}),g.datatables){$.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",deferRender:!0,retrieve:!0,stateDuration:0,rowId:"id",defaultContent:"",language:{url:g.datatablesLanguage}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})});var e=".dataTables_filter";$(document).on("preInit.dt",function(t,a){$(e+" input").off("keyup.DT input.DT")}),$(document).on("input keyup",e+" input",$.debounce(g.datatablesSearchDelay,function(t){var a=$(this).parents(e).attr("id").replace("_filter",""),n=g.tables[a];n.search(this.value).draw()}))}}$(document).on("click",function(e){$(e.target).closest(".submenu").length||($(".dropdown-menu").each(function(){$(this).hasClass("menu-static")||$(this).removeClass("active")}),$(".slidedown-menu").each(function(){$(this).hasClass("menu-static")||$(this).slideUp()}))}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault(),$(this).toggleClass("active");var t=$(this).next();$(".dropdown-menu.active").not(t[0]).removeClass("active"),t.toggleClass("active")}),$(document).on("click",".slidedown-toggle",function(e){e.preventDefault(),$(e.target).closest(".dropdown-menu").length||$(".dropdown-menu.active").removeClass("active"),$(this).toggleClass("active"),$(this).next().slideToggle()}),$(document).on("click",F+" "+L,function(){$(this).closest(F).remove()}),"function"==typeof this.callback&&this.callback(),$(document).on("submit","form",function(e){return e.preventDefault(),t({that:$(this),method:"post",queue:$(this).data("ajaxQueue"),action:$(this).attr("action"),data:$(this).serialize()}),!1}),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:g.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e){var t=$.Deferred();if(o(e.that),n(e.that),"get"==e.method)var a=$.getq(e.queue,e.action,e.data);else var a=$.postq(e.queue,e.action,e.data);return a.done(function(a,n,o){$.each(a,function(e){if("object"==typeof a[e]){if(a[e].updateTable){var n=g.tables["datatable"+e];a[e].ajax&&"function"==typeof n.ajax.url()?n.clearPipeline().draw(!1):a[e].data&&n.clear().rows.add(a[e].data).draw()}a[e].reloadTable&&(a[e].table=e,t.resolve(a[e]))}}),a.redirect?window.location.href=a.redirect:(i(e.that),c(e.that,a),a.success?p(e.that,a.success):a.errors&&d(e.that,a.errors))}),a.fail(function(t,a,n){"abort"!=a&&(i(e.that),422==t.status?l(e.that,t.responseJSON):u(e.that,a+": "+n))}),t.promise()}function a(e,t,a){var n=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),i=e.find("input:radio, input:checkbox");a?(n.each(function(){$(this).is(a)&&$(this).val("")}),i.each(function(){$(this).is(a)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(n.not(t).val(""),i.not(t).removeAttr("checked").removeAttr("selected")):(n.val(""),i.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),e.lock_timer=window.setTimeout(function(){$(v).prependTo(e.closest(R)).focus(),$(N,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var a=t.keyCode?t.keyCode:t.which;return 27==a&&i(e),!1})},M),!0}function i(e){return window.clearTimeout(e.lock_timer),e.prev(F).empty(),$("[type=submit]",e).prop("disabled",!1),$(N,e).remove(),!0}function o(e){/^sync-/.test(e.data("ajaxQueue"))&&$.ajaxq.isRunning(e.data("ajaxQueue"))&&$.ajaxq.abort(e.data("ajaxQueue"))}function r(e,t){var a=e.prev(F);a.length>0?a.append(t):($(S+t+A).insertBefore(e),a=e.prev(F)),isElementInViewport(a[0])||$.scrollTo(a[0])}function s(e){$(E,e).remove(),$(I,e).removeClass(P)}function l(e,t){s(e);var a="";if("object"==typeof t){a+=y+x;for(var n in t){$("#input-"+n).next().hasClass(J)?$("#input-"+n).after(O).closest(I).addClass(P):$("#input-"+n).closest(I).addClass(Q).append(O);for(var i=0;i<t[n].length;i++)a+=w+D+t[n][i]+C}a+=j+k}r(e,a)}function c(e,t){var n=[],i=[];if(t.resetOnly){for(var o=0;o<t.resetOnly.length;o++)i.push("#input-"+t.resetOnly[o]);i.length&&a(e,null,i.join())}else if(t.resetExcept){for(var o=0;o<t.resetExcept.length;o++)n.push("#input-"+t.resetExcept[o]);n.length&&a(e,n.join())}else t.reset&&a(e)}function d(e,t){s(e);var a="";if("object"==typeof t){if(t.errors){a+=y+x;for(var n=0;n<t.errors.length;n++)a+=w+D+t.errors[n]+C;a+=j+k}if(t.ids)for(var n=0;n<t.ids.length;n++)$("#input-"+t.ids[n]).next().hasClass(J)?$("#input-"+t.ids[n]).after(O).closest(I).addClass(P):$("#input-"+t.ids[n]).closest(I).addClass(Q).append(O)}r(e,a)}function u(e,t){s(e),t=y+D+t+k,r(e,t)}function p(e,t){s(e),t=q+t+T,r(e,t)}function f(e,t,a){var n=[];return a&&n.push({data:"id",title:'<input type="checkbox" value="1" name="check-'+e+'" id="input-check-'+e+'">'}),$.each(t,function(e,t){n.push({data:t.id,title:t.name})}),n}function h(e){$.each(e,function(e,t){g.tables["datatable"+e]=$("#datatable"+e).DataTable({paging:t.count>g.datatablesPaging?!0:!1,searchDelay:t.ajax?g.datatablesSearchDelay:0,serverSide:t.ajax?!0:!1,pagingType:g.datatablesPagingType[t.size],pageLength:g.datatablesPageLength[t.size],lengthMenu:g.datatablesLengthMenu[t.size],order:[[t.checkbox?++t.orderByColumn:t.orderByColumn,t.order]],ajax:t.ajax?m({url:t.url}):null,data:t.data?t.data:null,columns:f(e,t.columns,t.checkbox),columnDefs:t.checkbox?[{targets:0,width:"1.25em",searchable:!1,orderable:!1,className:"text-center",render:function(e,t,a,n){return'<input type="checkbox">'}}]:null})})}function m(e){var e=$.extend({pipeline:g.datatablesPipeline,url:"",data:null,method:"get"},e),a=-1,n=null,i=null,o=null;return function(r,s,l){var c=!1,d=r.start,u=r.start,p=r.length;0>p&&(p=0);var f=d+p;if(l.clearCache?(c=!0,l.clearCache=!1):0==p||0>a||a>d||f>n?c=!0:(JSON.stringify(r.order)!==JSON.stringify(i.order)||JSON.stringify(r.columns)!==JSON.stringify(i.columns)||JSON.stringify(r.search)!==JSON.stringify(i.search))&&(c=!0),i=$.extend(!0,{},r),c){if(a>d&&(d-=p*(e.pipeline-1),0>d&&(d=0)),a=d,n=d+p*e.pipeline,r.start=d,r.length=p*e.pipeline,$.isFunction(e.data)){var h=e.data(r);h&&$.extend(r,h)}else $.isPlainObject(e.data)&&$.extend(r,e.data);var m=$(this).closest(R),v=t({that:m,method:e.method,queue:m.data("ajaxQueue"),action:e.url,data:r});v.done(function(e){o=$.extend(!0,{},e),a!=u&&e.data.splice(0,u-a),p>0&&e.data.splice(p,e.data.length),e.search&&$("#datatable"+e.table+"_filter input").focus(),s(e)})}else{var g=$.extend(!0,{},o);g.draw=r.draw,g.data.splice(0,d-a),p>0&&g.data.splice(p,g.data.length),s(g)}}}var v,g={tables:[]},b=".js-create",y='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',x="<ul>",w="<li>",C="</li>",j="</ul>",k="</div>",q='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',T="</div>",S='<div class="alert-messages">',A="</div>",D='<span class="glyphicon glyphicon-warning-sign"></span>',O='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',E="span.glyphicon-remove",I=".form-group",Q="has-error has-feedback",P=Q+" has-addon-feedback",R=".ajax-lock",N=".ajax-locked",F=".alert-messages",J="input-group-addon",L="button.close",M=0;return{run:e,variables:g,datatables:h}}();
