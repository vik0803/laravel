...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function n(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var a=e.scrollTo=function(t,n,a){return e(window).scrollTo(t,n,a)};return a.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(o,i,s){"object"==typeof i&&(s=i,i=0),"function"==typeof s&&(s={onAfter:s}),"max"===o&&(o=9e9),s=e.extend({},a.defaults,s),i=i||s.duration;var r=s.queue&&s.axis.length>1;return r&&(i/=2),s.offset=n(s.offset),s.over=n(s.over),this.each(function(){function l(t){var n=e.extend({},s,{queue:!0,duration:i,complete:t&&function(){t.call(u,f,s)}});p.animate(h,n)}if(null!==o){var c,d=t(this),u=d?this.contentWindow||window:this,p=e(u),f=o,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=n(f);break}if(f=d?e(f):e(f,u),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(s.offset)&&s.offset(u,f)||s.offset;e.each(s.axis.split(""),function(e,t){var n="x"===t?"Left":"Top",o=n.toLowerCase(),i="scroll"+n,g=p[i](),v=a.max(u,t);if(c)h[i]=c[o]+(d?0:g-p.offset()[o]),s.margin&&(h[i]-=parseInt(f.css("margin"+n),10)||0,h[i]-=parseInt(f.css("border"+n+"Width"),10)||0),h[i]+=m[o]||0,s.over[o]&&(h[i]+=f["x"===t?"width":"height"]()*s.over[o]);else{var b=f[o];h[i]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*v:b}s.limit&&/^\d+$/.test(h[i])&&(h[i]=h[i]<=0?0:Math.min(h[i],v)),!e&&s.axis.length>1&&(g===h[i]?h={}:r&&(l(s.onAfterFirst),h={}))}),l(s.onAfter)}})},a.max=function(n,a){var o="x"===a?"Width":"Height",i="scroll"+o;if(!t(n))return n[i]-e(n)[o.toLowerCase()]();var s="client"+o,r=n.ownerDocument||n.document,l=r.documentElement,c=r.body;return Math.max(l[i],c[i])-Math.min(l[s],c[s])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var n=this.get(t);if(t.options.interrupt&&t._last&&t._last!==n)return e(t.elem).stop();var a=Math.round(t.now);n!==a&&(e(t.elem)[t.prop](a),t._last=this.get(t))}},a});
!function(e,t){"$:nomunge";var n,a=e.jQuery||e.Cowboy||(e.Cowboy={});a.throttle=n=function(e,n,o,i){function s(){function a(){l=+new Date,o.apply(c,u)}function s(){r=t}var c=this,d=+new Date-l,u=arguments;i&&!r&&a(),r&&clearTimeout(r),i===t&&d>e?a():n!==!0&&(r=setTimeout(i?s:a,i===t?e-d:e))}var r,l=0;return"boolean"!=typeof n&&(i=o,o=n,n=t),a.guid&&(s.guid=o.guid=o.guid||a.guid++),s},a.debounce=function(e,a,o){return o===t?n(e,a,!1):n(e,o,a!==!1)}}(this);
/*!
