!function(){for(var e,t=function(){},a=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],n=a.length,i=window.console=window.console||{};n--;)e=a[n],i[e]||(i[e]=t)}();
function isElementInViewport(e){var t=e.getBoundingClientRect();return t.top>=0&&t.left>=0&&t.bottom<=$(window).height()&&t.right<=$(window).width()}
;function placeholder(){if(jQuery.support.placeholder="placeholder"in document.createElement("input"),!$.support.placeholder){var e=document.activeElement;$(':text, input[type="date"], textarea').focus(function(){""!=$(this).attr("placeholder")&&$(this).val()==$(this).attr("placeholder")&&$(this).val("").removeClass("js-ie-placeholder")}).blur(function(){""==$(this).attr("placeholder")||""!=$(this).val()&&$(this).val()!=$(this).attr("placeholder")||$(this).val($(this).attr("placeholder")).addClass("js-ie-placeholder")}),$(':text, input[type="date"], textarea').blur(),$(e).focus(),$("form:eq(0)").submit(function(){$(':text.js-ie-placeholder, input[type="date"].js-ie-placeholder, textarea.js-ie-placeholder').val("")})}}
;!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){var t={},a={};e.ajaxq=function(n,i){function o(e){if(t[n])t[n].push(e);else{t[n]=[];var i=e();a[n]=i}}function r(){if(t[n]){var e=t[n].shift();if(e){var i=e();a[n]=i}else delete t[n],delete a[n]}}if("undefined"==typeof i)throw"AjaxQ: queue name is not provided";var s=e.Deferred(),l=s.promise();l.success=l.done,l.error=l.fail,l.complete=l.always;var c="function"==typeof i,d=c?null:e.extend(!0,{},i);return o(function(){var t=e.ajax.apply(window,[c?i():d]);return t.done(function(){s.resolve.apply(this,arguments)}),t.fail(function(){s.reject.apply(this,arguments)}),t.always(r),t}),l},e.each(["getq","postq"],function(t,a){e[a]=function(t,n,i,o,r){return e.isFunction(i)&&(r=r||o,o=i,i=void 0),e.ajaxq(t,{type:"postq"===a?"post":"get",url:n,data:i,success:o,dataType:r})}});var n=function(e){return t.hasOwnProperty(e)&&t[e].length>0||a.hasOwnProperty(e)},i=function(){for(var e in t)if(n(e))return!0;return!1};e.ajaxq.isRunning=function(e){return e?n(e):i()},e.ajaxq.getActiveRequest=function(e){if(!e)throw"AjaxQ: queue name is required";return a[e]},e.ajaxq.abort=function(n){if(!n)throw"AjaxQ: queue name is required";var i=e.ajaxq.getActiveRequest(n);delete t[n],delete a[n],i&&i.abort()},e.ajaxq.clear=function(e){if(e)t[e]&&(t[e]=[]);else for(var a in t)t.hasOwnProperty(a)&&(t[a]=[])}});
/*!
 DataTables 1.10.10
...
$.fn.toEm=function(e){e=jQuery.extend({scope:"body"},e);var t=parseInt(this[0],10),a=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),n=a.height();return a.remove(),(t/n).toFixed(8)},$.fn.toPx=function(e){e=jQuery.extend({scope:"body"},e);var t=parseFloat(this[0]),a=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),n=a.height();return a.remove(),Math.round(t*n)};
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function a(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var n=e.scrollTo=function(t,a,n){return e(window).scrollTo(t,a,n)};return n.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(i,o,r){"object"==typeof o&&(r=o,o=0),"function"==typeof r&&(r={onAfter:r}),"max"===i&&(i=9e9),r=e.extend({},n.defaults,r),o=o||r.duration;var s=r.queue&&r.axis.length>1;return s&&(o/=2),r.offset=a(r.offset),r.over=a(r.over),this.each(function(){function l(t){var a=e.extend({},r,{queue:!0,duration:o,complete:t&&function(){t.call(u,f,r)}});p.animate(h,a)}if(null!==i){var c,d=t(this),u=d?this.contentWindow||window:this,p=e(u),f=i,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=a(f);break}if(f=d?e(f):e(f,u),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(r.offset)&&r.offset(u,f)||r.offset;e.each(r.axis.split(""),function(e,t){var a="x"===t?"Left":"Top",i=a.toLowerCase(),o="scroll"+a,v=p[o](),g=n.max(u,t);if(c)h[o]=c[i]+(d?0:v-p.offset()[i]),r.margin&&(h[o]-=parseInt(f.css("margin"+a),10)||0,h[o]-=parseInt(f.css("border"+a+"Width"),10)||0),h[o]+=m[i]||0,r.over[i]&&(h[o]+=f["x"===t?"width":"height"]()*r.over[i]);else{var b=f[i];h[o]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*g:b}r.limit&&/^\d+$/.test(h[o])&&(h[o]=h[o]<=0?0:Math.min(h[o],g)),!e&&r.axis.length>1&&(v===h[o]?h={}:s&&(l(r.onAfterFirst),h={}))}),l(r.onAfter)}})},n.max=function(a,n){var i="x"===n?"Width":"Height",o="scroll"+i;if(!t(a))return a[o]-e(a)[i.toLowerCase()]();var r="client"+i,s=a.ownerDocument||a.document,l=s.documentElement,c=s.body;return Math.max(l[o],c[o])-Math.min(l[r],c[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var a=this.get(t);if(t.options.interrupt&&t._last&&t._last!==a)return e(t.elem).stop();var n=Math.round(t.now);a!==n&&(e(t.elem)[t.prop](n),t._last=this.get(t))}},n});
!function(e,t){"$:nomunge";var a,n=e.jQuery||e.Cowboy||(e.Cowboy={});n.throttle=a=function(e,a,i,o){function r(){function n(){l=+new Date,i.apply(c,u)}function r(){s=t}var c=this,d=+new Date-l,u=arguments;o&&!s&&n(),s&&clearTimeout(s),o===t&&d>e?n():a!==!0&&(s=setTimeout(o?r:n,o===t?e-d:e))}var s,l=0;return"boolean"!=typeof a&&(o=i,i=a,a=t),n.guid&&(r.guid=i.guid=i.guid||n.guid++),r},n.debounce=function(e,n,i){return i===t?a(e,n,!1):a(e,i,n!==!1)}}(this);
/*!
...
!function(e){if("function"==typeof define&&define.amd)define(e);else if("object"==typeof exports)module.exports=e();else{var t=window.Cookies,a=window.Cookies=e(window.jQuery);a.noConflict=function(){return window.Cookies=t,a}}}(function(){function e(){for(var e=0,t={};e<arguments.length;e++){var a=arguments[e];for(var n in a)t[n]=a[n]}return t}function t(a){function n(t,i,o){var r;if(arguments.length>1){if(o=e({path:"/"},n.defaults,o),"number"==typeof o.expires){var s=new Date;s.setMilliseconds(s.getMilliseconds()+864e5*o.expires),o.expires=s}try{r=JSON.stringify(i),/^[\{\[]/.test(r)&&(i=r)}catch(l){}return i=encodeURIComponent(String(i)),i=i.replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),t=encodeURIComponent(String(t)),t=t.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),t=t.replace(/[\(\)]/g,escape),document.cookie=[t,"=",i,o.expires&&"; expires="+o.expires.toUTCString(),o.path&&"; path="+o.path,o.domain&&"; domain="+o.domain,o.secure?"; secure":""].join("")}t||(r={});for(var c=document.cookie?document.cookie.split("; "):[],d=/(%[0-9A-Z]{2})+/g,u=0;u<c.length;u++){var p=c[u].split("="),f=p[0].replace(d,decodeURIComponent),h=p.slice(1).join("=");'"'===h.charAt(0)&&(h=h.slice(1,-1));try{if(h=a&&a(h,f)||h.replace(d,decodeURIComponent),this.json)try{h=JSON.parse(h)}catch(l){}if(t===f){r=h;break}t||(r[f]=h)}catch(l){}}return r}return n.get=n.set=n,n.getJSON=function(){return n.apply({json:!0},[].slice.call(arguments))},n.defaults={},n.remove=function(t,a){n(t,"",e(a,{expires:-1}))},n.withConverter=t,n}return t()});
/*!
...
var unikat=function(){"use strict";function e(){if(g='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+b.loadingImageSrc+'" alt="'+b.loadingImageAlt+'" title="'+b.loadingImageTitle+'">'+b.loadingText+"</div></div></div>",x=b.ajaxErrorMessage+x,placeholder(),!b.is_auth){window.history.location||window.location;$(window).on("popstate",function(e){var t=$(".sidebar"),a=$(".sidebar-tabs li"),n=window.location.hash,i=n?t.index($(n)):0,o=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),a.removeClass("sidebar-tab-active"),t.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),a.eq(i).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:b.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var a=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:a?a.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),a=$(".sidebar-tabs li"),n=$(".sidebar"),i=a.index(t);a.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),n.removeClass("sidebar-active"),n.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var o=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})});var e={type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:b.magnificPopupClose,tLoading:b.magnificPopupLoading,ajax:{tError:b.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in"};$(document).on("click",b.jsCreateHook,function(t){t.preventDefault();var a=$(this).data("table"),n=-1==$(this).attr("href").indexOf("?")?"?":"&",i=$(this).attr("href")+(a?n+"table="+a:"");$.magnificPopup.open($.extend(e,{items:{src:i}}))}),$(document).on("click",b.jsDestroyHook,function(t){t.preventDefault();var a=$(this).data("table"),n=-1==$(this).attr("href").indexOf("?")?"?":"&",i=$(this).attr("href")+(a?n+"table="+a:"");$.magnificPopup.open($.extend(e,{items:{src:i}}))}),b.datatables&&($.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}),$(document).on("preInit.dt",function(e,t){$(b.filterClass+" input").off("keyup.DT input.DT")}),$(document).on("input keyup",b.filterClass+" input",$.debounce(b.datatablesSearchDelay,function(e){var t=$(this).closest(b.filterClass).attr("id").replace("_filter",""),a=b.tables[t];a.search(this.value).draw()})),$(document).on("click",'.table-checkbox thead input[type="checkbox"]',function(e){var t=$(this).closest("table").attr("id");this.checked?$("#"+t+' tbody input[type="checkbox"]:not(:checked)').trigger("click"):$("#"+t+' tbody input[type="checkbox"]:checked').trigger("click"),e.stopPropagation()}),$(document).on("click",".table-checkbox tbody td, .table-checkbox thead th:first-child",function(e){$(this).parent().find('input[type="checkbox"]').trigger("click")}),$(document).on("click",'.table-checkbox tbody input[type="checkbox"]',function(e){var t=$(this).closest("table").attr("id"),a=$(this).closest("tr"),n=a.attr("id"),i=$.inArray(n,b.rows_selected.tableId);this.checked&&-1===i?b.rows_selected.tableId.push(n):this.checked||-1===i||b.rows_selected.tableId.splice(i,1),this.checked?a.addClass("selected"):a.removeClass("selected"),h(t),e.stopPropagation()}))}$(document).on("click",function(e){$(e.target).closest(".submenu").length||($(".dropdown-menu").each(function(){$(this).hasClass("menu-static")||$(this).removeClass("active")}),$(".slidedown-menu").each(function(){$(this).hasClass("menu-static")||$(this).slideUp()}))}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault(),$(this).toggleClass("active");var t=$(this).next();$(".dropdown-menu.active").not(t[0]).removeClass("active"),t.toggleClass("active")}),$(document).on("click",".slidedown-toggle",function(e){e.preventDefault(),$(e.target).closest(".dropdown-menu").length||$(".dropdown-menu.active").removeClass("active"),$(this).toggleClass("active"),$(this).next().slideToggle()}),$(document).on("click",R+" "+F,function(){$(this).closest(R).remove()}),"function"==typeof this.callback&&this.callback(),$(document).on("submit","form",function(e){e.preventDefault();var a=[],n=$("#input-table").val();if("undefined"!=typeof n){b.datatablePrefix+n;$.each(b.rows_selected.tableId,function(e,t){a.push({name:"id[]",value:t})})}return t({that:$(this),method:"post",queue:$(this).data("ajaxQueue"),action:$(this).attr("action"),data:$(this).serialize()+"&"+$.param(a)}),!1}),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:b.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e){var t=$.Deferred();if(o(e.that),n(e.that),"get"==e.method)var a=$.getq(e.queue,e.action,e.data);else var a=$.postq(e.queue,e.action,e.data);return a.done(function(a,n,o){var r=e.that;$.each(a,function(e){if("object"==typeof a[e]){if(a[e].updateTable){r=$("#"+b.datatablePrefix+e).closest(N);var n=b.tables[b.datatablePrefix+e];a[e].ajax&&"function"==typeof n.ajax.url()?n.clearPipeline().draw(!1):a[e].data&&n.clear().rows.add(a[e].data).draw()}a[e].reloadTable&&(a[e].table=e,t.resolve(a[e]))}}),a.redirect?window.location.href=a.redirect:(i(e.that),c(e.that,a),a.success?(a.closePopup&&(e.that=r,$.magnificPopup.close()),p(e.that,a.success)):a.errors&&d(e.that,a))}),a.fail(function(t,a,n){"abort"!=a&&(i(e.that),422==t.status?l(e.that,t.responseJSON):u(e.that,a+": "+n))}),t.promise()}function a(e,t,a){var n=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),i=e.find("input:radio, input:checkbox");a?(n.each(function(){$(this).is(a)&&$(this).val("")}),i.each(function(){$(this).is(a)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(n.not(t).val(""),i.not(t).removeAttr("checked").removeAttr("selected")):(n.val(""),i.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),e.lock_timer=window.setTimeout(function(){$(g).prependTo(e.closest(N)).focus(),$(_,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var a=t.keyCode?t.keyCode:t.which;return 27==a&&i(e),!1})},b.lock_time),!0}function i(e){return window.clearTimeout(e.lock_timer),e.prev(R).empty(),$("[type=submit]",e).prop("disabled",!1),$(_,e).remove(),!0}function o(e){/^sync-/.test(e.data("ajaxQueue"))&&$.ajaxq.isRunning(e.data("ajaxQueue"))&&$.ajaxq.abort(e.data("ajaxQueue"))}function r(e,t){var a=e.prev(R);a.length>0?a.append(t):($(S+t+D).insertBefore(e),a=e.prev(R)),isElementInViewport(a[0])||$.scrollTo(a[0])}function s(e){$(A,e).remove(),$(E,e).removeClass(Q)}function l(e,t){s(e);var a="";if("object"==typeof t){a+=y+x;for(var n in t){$("#input-"+n).next().hasClass(J)?$("#input-"+n).after(P).closest(E).addClass(Q):$("#input-"+n).closest(E).addClass(I).append(P);for(var i=0;i<t[n].length;i++)a+=k+O+t[n][i]+w}a+=C+j}r(e,a)}function c(e,t){var n=[],i=[];if(t.resetOnly){for(var o=0;o<t.resetOnly.length;o++)i.push("#input-"+t.resetOnly[o]);i.length&&a(e,null,i.join())}else if(t.resetExcept){for(var o=0;o<t.resetExcept.length;o++)n.push("#input-"+t.resetExcept[o]);n.length&&a(e,n.join())}else t.reset&&a(e)}function d(e,t){s(e);var a="";if("object"==typeof t){if(t.errors){a+=y+x;for(var n=0;n<t.errors.length;n++)a+=k+O+t.errors[n]+w;a+=C+j}if(t.ids)for(var n=0;n<t.ids.length;n++)$("#input-"+t.ids[n]).next().hasClass(J)?$("#input-"+t.ids[n]).after(P).closest(E).addClass(Q):$("#input-"+t.ids[n]).closest(E).addClass(I).append(P)}r(e,a)}function u(e,t){s(e),t=y+O+t+j,r(e,t)}function p(e,t){s(e),t=q+t+T,r(e,t)}function f(e,t,a){var n=[];return a&&n.push({data:"id",title:'<input type="checkbox" value="1" name="check-'+e+'" id="input-check-'+e+'">'}),$.each(t,function(e,t){n.push({data:t.id,title:t.name})}),n}function h(e){var t=$("#"+e),a=$('tbody input[type="checkbox"]',t),n=$('tbody input[type="checkbox"]:checked',t),i=$('thead input[type="checkbox"]',t).get(0);0===n.length?(t.closest(".dataTableWrapper").find("a.js-destroy").addClass("disabled"),i.checked=!1,"indeterminate"in i&&(i.indeterminate=!1)):(t.closest(".dataTableWrapper").find("a.js-destroy").removeClass("disabled"),n.length===a.length?(i.checked=!0,"indeterminate"in i&&(i.indeterminate=!1)):(i.checked=!0,"indeterminate"in i&&(i.indeterminate=!0)))}function m(e){$.each(e,function(e,t){var a=b.datatablePrefix+e;b.rows_selected.tableId=[],b.tables[a]=$("#"+a).DataTable({dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,rowId:"id",defaultContent:"",language:{url:b.datatablesLanguage},paging:t.count>b.datatablesPaging?!0:!1,searchDelay:t.ajax?b.datatablesSearchDelay:0,serverSide:t.ajax?!0:!1,pagingType:b.datatablesPagingType[t.size],pageLength:b.datatablesPageLength[t.size],lengthMenu:b.datatablesLengthMenu[t.size],order:[[t.checkbox?++t.orderByColumn:t.orderByColumn,t.order]],ajax:t.ajax?v({url:t.url}):null,data:t.data?t.data:null,columns:f(e,t.columns,t.checkbox),columnDefs:t.checkbox?[{targets:0,width:"1.25em",searchable:!1,orderable:!1,className:"text-center",render:function(e,t,a,n){return'<input type="checkbox">'}}]:null,createdRow:t.checkbox?function(e,t,a){-1!==$.inArray(e.id,b.rows_selected.tableId)&&($(e).find('input[type="checkbox"]').prop("checked",!0),$(e).addClass("selected"))}:null,drawCallback:t.checkbox?function(e){h(a)}:null})})}function v(e){var e=$.extend({pipeline:b.datatablesPipeline,url:"",data:null,method:"get"},e),a=-1,n=null,i=null,o=null;return function(r,s,l){var c=!1,d=r.start,u=r.start,p=r.length;0>p&&(p=0);var f=d+p;if(l.clearCache?(c=!0,l.clearCache=!1):0==p||0>a||a>d||f>n?c=!0:(JSON.stringify(r.order)!==JSON.stringify(i.order)||JSON.stringify(r.columns)!==JSON.stringify(i.columns)||JSON.stringify(r.search)!==JSON.stringify(i.search))&&(c=!0),i=$.extend(!0,{},r),c){if(a>d&&(d-=p*(e.pipeline-1),0>d&&(d=0)),a=d,n=d+p*e.pipeline,r.start=d,r.length=p*e.pipeline,$.isFunction(e.data)){var h=e.data(r);h&&$.extend(r,h)}else $.isPlainObject(e.data)&&$.extend(r,e.data);var m=$(this).closest(N),v=t({that:m,method:e.method,queue:m.data("ajaxQueue"),action:e.url,data:r});v.done(function(e){o=$.extend(!0,{},e),a!=u&&e.data.splice(0,u-a),p>0&&e.data.splice(p,e.data.length),e.search&&$("#"+b.datatablePrefix+e.table+"_filter input").focus(),s(e)})}else{var g=$.extend(!0,{},o);g.draw=r.draw,g.data.splice(0,d-a),p>0&&g.data.splice(p,g.data.length),s(g)}}}var g,b={tables:[],rows_selected:{},lock_time:0,jsCreateHook:".js-create",jsDestroyHook:".js-destroy",filterClass:".dataTables_filter",datatablePrefix:"datatable"},y='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',x="<ul>",k="<li>",w="</li>",C="</ul>",j="</div>",q='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',T="</div>",S='<div class="alert-messages">',D="</div>",O='<span class="glyphicon glyphicon-warning-sign"></span>',P='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',A="span.glyphicon-remove",E=".form-group",I="has-error has-feedback",Q=I+" has-addon-feedback",N=".ajax-lock",_=".ajax-locked",R=".alert-messages",J="input-group-addon",F="button.close";return{run:e,variables:b,datatables:m}}();
