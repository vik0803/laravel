...
function isElementInViewport(e){var n=e.getBoundingClientRect();return n.top>=0&&n.left>=0&&n.bottom<=$(window).height()&&n.right<=$(window).width()}
...
$.fn.toEm=function(e){e=jQuery.extend({scope:"body"},e);var t=parseInt(this[0],10),i=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),o=i.height();return i.remove(),(t/o).toFixed(8)},$.fn.toPx=function(e){e=jQuery.extend({scope:"body"},e);var t=parseFloat(this[0]),i=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),o=i.height();return i.remove(),Math.round(t*o)};
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function o(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var n=e.scrollTo=function(t,o,n){return e(window).scrollTo(t,o,n)};return n.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(i,r,a){"object"==typeof r&&(a=r,r=0),"function"==typeof a&&(a={onAfter:a}),"max"===i&&(i=9e9),a=e.extend({},n.defaults,a),r=r||a.duration;var s=a.queue&&a.axis.length>1;return s&&(r/=2),a.offset=o(a.offset),a.over=o(a.over),this.each(function(){function l(t){var o=e.extend({},a,{queue:!0,duration:r,complete:t&&function(){t.call(c,f,a)}});p.animate(h,o)}if(null!==i){var u,d=t(this),c=d?this.contentWindow||window:this,p=e(c),f=i,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=o(f);break}if(f=d?e(f):e(f,c),!f.length)return;case"object":(f.is||f.style)&&(u=(f=e(f)).offset())}var m=e.isFunction(a.offset)&&a.offset(c,f)||a.offset;e.each(a.axis.split(""),function(e,t){var o="x"===t?"Left":"Top",i=o.toLowerCase(),r="scroll"+o,v=p[r](),g=n.max(c,t);if(u)h[r]=u[i]+(d?0:v-p.offset()[i]),a.margin&&(h[r]-=parseInt(f.css("margin"+o),10)||0,h[r]-=parseInt(f.css("border"+o+"Width"),10)||0),h[r]+=m[i]||0,a.over[i]&&(h[r]+=f["x"===t?"width":"height"]()*a.over[i]);else{var x=f[i];h[r]=x.slice&&"%"===x.slice(-1)?parseFloat(x)/100*g:x}a.limit&&/^\d+$/.test(h[r])&&(h[r]=h[r]<=0?0:Math.min(h[r],g)),!e&&a.axis.length>1&&(v===h[r]?h={}:s&&(l(a.onAfterFirst),h={}))}),l(a.onAfter)}})},n.max=function(o,n){var i="x"===n?"Width":"Height",r="scroll"+i;if(!t(o))return o[r]-e(o)[i.toLowerCase()]();var a="client"+i,s=o.ownerDocument||o.document,l=s.documentElement,u=s.body;return Math.max(l[r],u[r])-Math.min(l[a],u[a])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var o=this.get(t);if(t.options.interrupt&&t._last&&t._last!==o)return e(t.elem).stop();var n=Math.round(t.now);o!==n&&(e(t.elem)[t.prop](n),t._last=this.get(t))}},n});
!function(e,t){"$:nomunge";var o,n=e.jQuery||e.Cowboy||(e.Cowboy={});n.throttle=o=function(e,o,i,r){function a(){function n(){l=+new Date,i.apply(u,c)}function a(){s=t}var u=this,d=+new Date-l,c=arguments;r&&!s&&n(),s&&clearTimeout(s),r===t&&d>e?n():o!==!0&&(s=setTimeout(r?a:n,r===t?e-d:e))}var s,l=0;return"boolean"!=typeof o&&(r=i,i=o,o=t),n.guid&&(a.guid=i.guid=i.guid||n.guid++),a},n.debounce=function(e,n,i){return i===t?o(e,n,!1):o(e,i,n!==!1)}}(this);
/*!
...
!function(e){if("function"==typeof define&&define.amd)define(e);else if("object"==typeof exports)module.exports=e();else{var t=window.Cookies,n=window.Cookies=e(window.jQuery);n.noConflict=function(){return window.Cookies=t,n}}}(function(){function e(){for(var e=0,t={};e<arguments.length;e++){var n=arguments[e];for(var o in n)t[o]=n[o]}return t}function t(n){function o(t,i,r){var a;if(arguments.length>1){if(r=e({path:"/"},o.defaults,r),"number"==typeof r.expires){var s=new Date;s.setMilliseconds(s.getMilliseconds()+864e5*r.expires),r.expires=s}try{a=JSON.stringify(i),/^[\{\[]/.test(a)&&(i=a)}catch(u){}return i=encodeURIComponent(String(i)),i=i.replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),t=encodeURIComponent(String(t)),t=t.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),t=t.replace(/[\(\)]/g,escape),document.cookie=[t,"=",i,r.expires&&"; expires="+r.expires.toUTCString(),r.path&&"; path="+r.path,r.domain&&"; domain="+r.domain,r.secure?"; secure":""].join("")}t||(a={});for(var l=document.cookie?document.cookie.split("; "):[],c=/(%[0-9A-Z]{2})+/g,d=0;d<l.length;d++){var p=l[d].split("="),f=p[0].replace(c,decodeURIComponent),h=p.slice(1).join("=");'"'===h.charAt(0)&&(h=h.slice(1,-1));try{if(h=n&&n(h,f)||h.replace(c,decodeURIComponent),this.json)try{h=JSON.parse(h)}catch(u){}if(t===f){a=h;break}t||(a[f]=h)}catch(u){}}return a}return o.get=o.set=o,o.getJSON=function(){return o.apply({json:!0},[].slice.call(arguments))},o.defaults={},o.remove=function(t,n){o(t,"",e(n,{expires:-1}))},o.withConverter=t,o}return t()});
/*!
...
var unikat=function(){"use strict";function e(){if(p='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+m.loadingImageSrc+'" alt="'+m.loadingImageAlt+'" title="'+m.loadingImageTitle+'">'+m.loadingText+"</div></div></div>",b=m.ajaxErrorMessage+b,placeholder(),!m.is_auth){window.history.location||window.location;$(window).on("popstate",function(e){var t=$(".sidebar"),n=$(".sidebar-tabs li"),a=window.location.hash,i=a?t.index($(a)):0,o=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),n.removeClass("sidebar-tab-active"),t.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),n.eq(i).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:m.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var n=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:n?n.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),n=$(".sidebar-tabs li"),a=$(".sidebar"),i=n.index(t);n.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),a.removeClass("sidebar-active"),a.eq(i).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var o=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:i,navState:o?o.navState:null},{expires:365})}),$("[id^="+g+"]").on("click",function(){$(this).attr("id").substring(g.length);$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:m.magnificPopupClose,tLoading:m.magnificPopupLoading,ajax:{tError:m.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:"http://cms.laravel.local/users/admins/create"}})}),m.datatables&&($.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",paging:m.datatablesCount<=10?!1:!0,stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,defaultContent:"",searchDelay:m.datatablesAjax?400:0,serverSide:m.datatablesAjax?!0:!1,pagingType:m.datatablesPagingType,pageLength:m.datatablesPageLength,lengthMenu:m.datatablesLengthMenu,language:{url:m.datatablesLanguage},initComplete:function(e,t){var n=$("input",e.aanFeatures.f);n.off("keyup.DT input.DT");var a=$(".dataTable").DataTable();$(document).on("input keyup",n.selector,$.debounce(e.searchDelay,function(e){a.search(this.value).draw()}))}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}))}$(document).on("click",function(e){$(e.target).closest(".dropdown").length||$(".dropdown-menu").each(function(){$(this).hasClass("dropdown-menu-static")||($(this).hasClass("dropdown-menu-slide")?$(this).slideUp():$(this).removeClass("active"))})}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault();var t=$(this).next();$(".dropdown-menu.active").not([".dropdown-menu-static",t[0]]).removeClass("active"),t.hasClass("dropdown-menu-slide")?t.slideToggle():t.toggleClass("active")}),$(document).on("click",F+" "+M,function(){$(this).closest(F).remove()}),"function"==typeof this.callback&&this.callback(),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:m.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e,t,n){var a=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),i=e.find("input:radio, input:checkbox");n?(a.each(function(){$(this).is(n)&&$(this).val("")}),i.each(function(){$(this).is(n)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(a.not(t).val(""),i.not(t).removeAttr("checked").removeAttr("selected")):(a.val(""),i.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),f=window.setTimeout(function(){$(p).prependTo(e.closest(J)).focus(),$(P,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var n=t.keyCode?t.keyCode:t.which;return 27==n&&a(e),!1})},R),!0}function a(e){return h.abort(),window.clearTimeout(f),e.prev(F).empty(),$("[type=submit]",e).prop("disabled",!1),$(P,e).remove(),!0}function i(e,t){var n=e.prev(F);n.length>0?n.append(t):($(T+t+S).insertBefore(e),n=e.prev(F)),isElementInViewport(n[0])||$.scrollTo(n[0])}function o(e){$(A,e).remove(),$(D,e).removeClass(I)}function s(e,t){o(e);var n="";if("object"==typeof t){n+=v+b;for(var a in t){$("#input-"+a).next().hasClass(L)?$("#input-"+a).after(O).closest(D).addClass(I):$("#input-"+a).closest(D).addClass(N).append(O);for(var s=0;s<t[a].length;s++)n+=y+E+t[a][s]+x}n+=C+w}i(e,n)}function r(e,n){o(e);var a="",s=[],r=[];if("object"==typeof n){if(n.errors){a+=v+b;for(var l=0;l<n.errors.length;l++)a+=y+E+n.errors[l]+x;a+=C+w}if(n.ids)for(var l=0;l<n.ids.length;l++)$("#input-"+n.ids[l]).next().hasClass(L)?$("#input-"+n.ids[l]).after(O).closest(D).addClass(I):$("#input-"+n.ids[l]).closest(D).addClass(N).append(O);if(n.resetOnly){for(var l=0;l<n.resetOnly.length;l++)r.push("#input-"+n.resetOnly[l]);r.length&&t(e,null,r.join())}else if(n.resetExcept){for(var l=0;l<n.resetExcept.length;l++)s.push("#input-"+n.resetExcept[l]);s.length&&t(e,s.join())}else n.reset&&t(e)}i(e,a)}function l(e,t){o(e),t=v+E+t+w,i(e,t)}function c(e,t){o(e),t=k+t+j,i(e,t)}function d(e){$("#"+e).submit(function(e){e.preventDefault();var i=$(this);return"undefined"!=typeof h&&a(i),n(i),h=$.post(i.attr("action"),i.serialize()),h.done(function(e,n,o){e.redirect?window.location.href=e.redirect:(a(i),e.success?(c(i,e.success),t(i)):r(i,e))}),h.fail(function(e,t,n){a(i),422==e.status?s(i,e.responseJSON):l(i,t+": "+n)}),!1})}function u(e){var e=$.extend({pipeline:m.datatablesPipeline,url:"",data:null,method:"GET"},e),i=-1,o=null,d=null,u=null;return function(p,f,m){var g=!1,v=p.start,b=p.start,y=p.length,x=v+y;if(m.clearCache?(g=!0,m.clearCache=!1):0>i||i>v||x>o?g=!0:(JSON.stringify(p.order)!==JSON.stringify(d.order)||JSON.stringify(p.columns)!==JSON.stringify(d.columns)||JSON.stringify(p.search)!==JSON.stringify(d.search))&&(g=!0),d=$.extend(!0,{},p),g){if(i>v&&(v-=y*(e.pipeline-1),0>v&&(v=0)),i=v,o=v+y*e.pipeline,p.start=v,p.length=y*e.pipeline,$.isFunction(e.data)){var C=e.data(p);C&&$.extend(p,C)}else $.isPlainObject(e.data)&&$.extend(p,e.data);var w=$(this).closest(J);"undefined"!=typeof h&&a(w),n(w),h="GET"==e.method?$.get(e.url,p):$.post(e.url,p),h.done(function(e,n,o){e.redirect?window.location.href=e.redirect:(a(w),e.success?(c(w,e.success),t(w)):e.errors?r(w,e):(u=$.extend(!0,{},e),i!=b&&e.data.splice(0,b-i),e.data.splice(y,e.data.length),f(e)))}),h.fail(function(e,t,n){a(w),422==e.status?s(w,e.responseJSON):l(w,t+": "+n)})}else{var k=$.extend(!0,{},u);k.draw=p.draw,k.data.splice(0,v-i),k.data.splice(y,k.data.length),f(k)}}}var p,f,h,m={},g="js-create-",v='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',b="<ul>",y="<li>",x="</li>",C="</ul>",w="</div>",k='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',j="</div>",T='<div class="alert-messages">',S="</div>",E='<span class="glyphicon glyphicon-warning-sign"></span>',O='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',A="span.glyphicon-remove",D=".form-group",N="has-error has-feedback",I=N+" has-addon-feedback",J=".ajax-lock",P=".ajax-locked",F=".alert-messages",L="input-group-addon",M="button.close",R=0;return{ajax_submit:d,datatables:u,run:e,variables:m}}();
