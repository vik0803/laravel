...
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function n(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var a=e.scrollTo=function(t,n,a){return e(window).scrollTo(t,n,a)};return a.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(o,i,r){"object"==typeof i&&(r=i,i=0),"function"==typeof r&&(r={onAfter:r}),"max"===o&&(o=9e9),r=e.extend({},a.defaults,r),i=i||r.duration;var s=r.queue&&r.axis.length>1;return s&&(i/=2),r.offset=n(r.offset),r.over=n(r.over),this.each(function(){function l(t){var n=e.extend({},r,{queue:!0,duration:i,complete:t&&function(){t.call(u,f,r)}});p.animate(h,n)}if(null!==o){var c,d=t(this),u=d?this.contentWindow||window:this,p=e(u),f=o,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=n(f);break}if(f=d?e(f):e(f,u),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(r.offset)&&r.offset(u,f)||r.offset;e.each(r.axis.split(""),function(e,t){var n="x"===t?"Left":"Top",o=n.toLowerCase(),i="scroll"+n,g=p[i](),v=a.max(u,t);if(c)h[i]=c[o]+(d?0:g-p.offset()[o]),r.margin&&(h[i]-=parseInt(f.css("margin"+n),10)||0,h[i]-=parseInt(f.css("border"+n+"Width"),10)||0),h[i]+=m[o]||0,r.over[o]&&(h[i]+=f["x"===t?"width":"height"]()*r.over[o]);else{var b=f[o];h[i]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*v:b}r.limit&&/^\d+$/.test(h[i])&&(h[i]=h[i]<=0?0:Math.min(h[i],v)),!e&&r.axis.length>1&&(g===h[i]?h={}:s&&(l(r.onAfterFirst),h={}))}),l(r.onAfter)}})},a.max=function(n,a){var o="x"===a?"Width":"Height",i="scroll"+o;if(!t(n))return n[i]-e(n)[o.toLowerCase()]();var r="client"+o,s=n.ownerDocument||n.document,l=s.documentElement,c=s.body;return Math.max(l[i],c[i])-Math.min(l[r],c[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var n=this.get(t);if(t.options.interrupt&&t._last&&t._last!==n)return e(t.elem).stop();var a=Math.round(t.now);n!==a&&(e(t.elem)[t.prop](a),t._last=this.get(t))}},a});
!function(e,t){"$:nomunge";var n,a=e.jQuery||e.Cowboy||(e.Cowboy={});a.throttle=n=function(e,n,o,i){function r(){function a(){l=+new Date,o.apply(c,u)}function r(){s=t}var c=this,d=+new Date-l,u=arguments;i&&!s&&a(),s&&clearTimeout(s),i===t&&d>e?a():n!==!0&&(s=setTimeout(i?r:a,i===t?e-d:e))}var s,l=0;return"boolean"!=typeof n&&(i=o,o=n,n=t),a.guid&&(r.guid=o.guid=o.guid||a.guid++),r},a.debounce=function(e,a,o){return o===t?n(e,a,!1):n(e,o,a!==!1)}}(this);
/*!
...
var unikat=function(){"use strict";function e(){if(u='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+h.loadingImageSrc+'" alt="'+h.loadingImageAlt+'" title="'+h.loadingImageTitle+'">'+h.loadingText+"</div></div></div>",v=h.ajaxErrorMessage+v,placeholder(),!h.is_auth){window.history.location||window.location;$(window).on("popstate",function(e){var t=$(".sidebar"),n=$(".sidebar-tabs li"),a=window.location.hash,o=a?t.index($(a)):0,i=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),n.removeClass("sidebar-tab-active"),t.eq(o).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),n.eq(o).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:o,navState:i?i.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:h.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var n=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:n?n.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),n=$(".sidebar-tabs li"),a=$(".sidebar"),o=n.index(t);n.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),a.removeClass("sidebar-active"),a.eq(o).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var i=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:o,navState:i?i.navState:null},{expires:365})}),$("body").on("click",m,function(e){e.preventDefault();var t=$(this).attr("href");$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:h.magnificPopupClose,tLoading:h.magnificPopupLoading,ajax:{tError:h.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:t}})}),h.datatables&&($.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",paging:h.datatablesCount<=10?!1:!0,stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,defaultContent:"",searchDelay:h.datatablesAjax?400:0,serverSide:h.datatablesAjax?!0:!1,pagingType:h.datatablesPagingType,pageLength:h.datatablesPageLength,lengthMenu:h.datatablesLengthMenu,language:{url:h.datatablesLanguage},initComplete:function(e,t){var n=$("input",e.aanFeatures.f);n.off("keyup.DT input.DT");var a=$(".dataTable").DataTable();$(document).on("input keyup",n.selector,$.debounce(e.searchDelay,function(e){a.search(this.value).draw()}))}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}))}$(document).on("click",function(e){$(e.target).closest(".submenu").length||($(".dropdown-menu").each(function(){$(this).hasClass("menu-static")||$(this).removeClass("active")}),$(".slidedown-menu").each(function(){$(this).hasClass("menu-static")||$(this).slideUp()}))}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault(),$(this).toggleClass("active");var t=$(this).next();$(".dropdown-menu.active").not(t[0]).removeClass("active"),t.toggleClass("active")}),$(document).on("click",".slidedown-toggle",function(e){e.preventDefault(),$(e.target).closest(".dropdown-menu").length||$(".dropdown-menu.active").removeClass("active"),$(this).toggleClass("active"),$(this).next().slideToggle()}),$(document).on("click",F+" "+L,function(){$(this).closest(F).remove()}),"function"==typeof this.callback&&this.callback(),$(document).on("submit","form",function(e){e.preventDefault();var o=$(this);return"undefined"!=typeof f&&a(o),n(o),f=$.post(o.attr("action"),o.serialize()),f.done(function(e,n,i){e.redirect?window.location.href=e.redirect:(a(o),e.success?(c(o,e.success),t(o)):s(o,e))}),f.fail(function(e,t,n){a(o),422==e.status?r(o,e.responseJSON):l(o,t+": "+n)}),!1}),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:h.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e,t,n){var a=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),o=e.find("input:radio, input:checkbox");n?(a.each(function(){$(this).is(n)&&$(this).val("")}),o.each(function(){$(this).is(n)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(a.not(t).val(""),o.not(t).removeAttr("checked").removeAttr("selected")):(a.val(""),o.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),p=window.setTimeout(function(){$(u).prependTo(e.closest(I)).focus(),$(J,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var n=t.keyCode?t.keyCode:t.which;return 27==n&&a(e),!1})},M),!0}function a(e){return f.abort(),window.clearTimeout(p),e.prev(F).empty(),$("[type=submit]",e).prop("disabled",!1),$(J,e).remove(),!0}function o(e,t){var n=e.prev(F);n.length>0?n.append(t):($(j+t+T).insertBefore(e),n=e.prev(F)),isElementInViewport(n[0])||$.scrollTo(n[0])}function i(e){$(O,e).remove(),$(D,e).removeClass(N)}function r(e,t){i(e);var n="";if("object"==typeof t){n+=g+v;for(var a in t){$("#input-"+a).next().hasClass(P)?$("#input-"+a).after(E).closest(D).addClass(N):$("#input-"+a).closest(D).addClass(A).append(E);for(var r=0;r<t[a].length;r++)n+=b+S+t[a][r]+y}n+=x+C}o(e,n)}function s(e,n){i(e);var a="",r=[],s=[];if("object"==typeof n){if(n.errors){a+=g+v;for(var l=0;l<n.errors.length;l++)a+=b+S+n.errors[l]+y;a+=x+C}if(n.ids)for(var l=0;l<n.ids.length;l++)$("#input-"+n.ids[l]).next().hasClass(P)?$("#input-"+n.ids[l]).after(E).closest(D).addClass(N):$("#input-"+n.ids[l]).closest(D).addClass(A).append(E);if(n.resetOnly){for(var l=0;l<n.resetOnly.length;l++)s.push("#input-"+n.resetOnly[l]);s.length&&t(e,null,s.join())}else if(n.resetExcept){for(var l=0;l<n.resetExcept.length;l++)r.push("#input-"+n.resetExcept[l]);r.length&&t(e,r.join())}else n.reset&&t(e)}o(e,a)}function l(e,t){i(e),t=g+S+t+C,o(e,t)}function c(e,t){i(e),t=w+t+k,o(e,t)}function d(e){var e=$.extend({pipeline:h.datatablesPipeline,url:"",data:null,method:"GET"},e),o=-1,i=null,d=null,u=null;return function(p,h,m){var g=!1,v=p.start,b=p.start,y=p.length,x=v+y;if(m.clearCache?(g=!0,m.clearCache=!1):0>o||o>v||x>i?g=!0:(JSON.stringify(p.order)!==JSON.stringify(d.order)||JSON.stringify(p.columns)!==JSON.stringify(d.columns)||JSON.stringify(p.search)!==JSON.stringify(d.search))&&(g=!0),d=$.extend(!0,{},p),g){if(o>v&&(v-=y*(e.pipeline-1),0>v&&(v=0)),o=v,i=v+y*e.pipeline,p.start=v,p.length=y*e.pipeline,$.isFunction(e.data)){var C=e.data(p);C&&$.extend(p,C)}else $.isPlainObject(e.data)&&$.extend(p,e.data);var w=$(this).closest(I);"undefined"!=typeof f&&a(w),n(w),f="GET"==e.method?$.get(e.url,p):$.post(e.url,p),f.done(function(e,n,i){e.redirect?window.location.href=e.redirect:(a(w),e.success?(c(w,e.success),t(w)):e.errors?s(w,e):(u=$.extend(!0,{},e),o!=b&&e.data.splice(0,b-o),e.data.splice(y,e.data.length),h(e)))}),f.fail(function(e,t,n){a(w),422==e.status?r(w,e.responseJSON):l(w,t+": "+n)})}else{var k=$.extend(!0,{},u);k.draw=p.draw,k.data.splice(0,v-o),k.data.splice(y,k.data.length),h(k)}}}var u,p,f,h={},m=".js-create",g='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',v="<ul>",b="<li>",y="</li>",x="</ul>",C="</div>",w='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',k="</div>",j='<div class="alert-messages">',T="</div>",S='<span class="glyphicon glyphicon-warning-sign"></span>',E='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',O="span.glyphicon-remove",D=".form-group",A="has-error has-feedback",N=A+" has-addon-feedback",I=".ajax-lock",J=".ajax-locked",F=".alert-messages",P="input-group-addon",L="button.close",M=0;return{datatables:d,run:e,variables:h}}();
