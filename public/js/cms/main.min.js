!function(){for(var e,t=function(){},n=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],a=n.length,o=window.console=window.console||{};a--;)e=n[a],o[e]||(o[e]=t)}();
...
$.fn.toEm=function(e){e=jQuery.extend({scope:"body"},e);var t=parseInt(this[0],10),n=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),a=n.height();return n.remove(),(t/a).toFixed(8)},$.fn.toPx=function(e){e=jQuery.extend({scope:"body"},e);var t=parseFloat(this[0]),n=jQuery('<div style="display: none; font-size: 1em; margin: 0; padding:0; height: auto; line-height: 1; border:0;">&nbsp;</div>').appendTo(e.scope),a=n.height();return n.remove(),Math.round(t*a)};
!function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery"],e):"undefined"!=typeof module&&module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){"use strict";function t(t){return!t.nodeName||-1!==e.inArray(t.nodeName.toLowerCase(),["iframe","#document","html","body"])}function n(t){return e.isFunction(t)||e.isPlainObject(t)?t:{top:t,left:t}}var o=e.scrollTo=function(t,n,o){return e(window).scrollTo(t,n,o)};return o.defaults={axis:"xy",duration:0,limit:!0},e.fn.scrollTo=function(a,i,r){"object"==typeof i&&(r=i,i=0),"function"==typeof r&&(r={onAfter:r}),"max"===a&&(a=9e9),r=e.extend({},o.defaults,r),i=i||r.duration;var s=r.queue&&r.axis.length>1;return s&&(i/=2),r.offset=n(r.offset),r.over=n(r.over),this.each(function(){function l(t){var n=e.extend({},r,{queue:!0,duration:i,complete:t&&function(){t.call(u,f,r)}});p.animate(h,n)}if(null!==a){var c,d=t(this),u=d?this.contentWindow||window:this,p=e(u),f=a,h={};switch(typeof f){case"number":case"string":if(/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)){f=n(f);break}if(f=d?e(f):e(f,u),!f.length)return;case"object":(f.is||f.style)&&(c=(f=e(f)).offset())}var m=e.isFunction(r.offset)&&r.offset(u,f)||r.offset;e.each(r.axis.split(""),function(e,t){var n="x"===t?"Left":"Top",a=n.toLowerCase(),i="scroll"+n,g=p[i](),v=o.max(u,t);if(c)h[i]=c[a]+(d?0:g-p.offset()[a]),r.margin&&(h[i]-=parseInt(f.css("margin"+n),10)||0,h[i]-=parseInt(f.css("border"+n+"Width"),10)||0),h[i]+=m[a]||0,r.over[a]&&(h[i]+=f["x"===t?"width":"height"]()*r.over[a]);else{var b=f[a];h[i]=b.slice&&"%"===b.slice(-1)?parseFloat(b)/100*v:b}r.limit&&/^\d+$/.test(h[i])&&(h[i]=h[i]<=0?0:Math.min(h[i],v)),!e&&r.axis.length>1&&(g===h[i]?h={}:s&&(l(r.onAfterFirst),h={}))}),l(r.onAfter)}})},o.max=function(n,o){var a="x"===o?"Width":"Height",i="scroll"+a;if(!t(n))return n[i]-e(n)[a.toLowerCase()]();var r="client"+a,s=n.ownerDocument||n.document,l=s.documentElement,c=s.body;return Math.max(l[i],c[i])-Math.min(l[r],c[r])},e.Tween.propHooks.scrollLeft=e.Tween.propHooks.scrollTop={get:function(t){return e(t.elem)[t.prop]()},set:function(t){var n=this.get(t);if(t.options.interrupt&&t._last&&t._last!==n)return e(t.elem).stop();var o=Math.round(t.now);n!==o&&(e(t.elem)[t.prop](o),t._last=this.get(t))}},o});
!function(e,t){"$:nomunge";var n,o=e.jQuery||e.Cowboy||(e.Cowboy={});o.throttle=n=function(e,n,a,i){function r(){function o(){l=+new Date,a.apply(c,u)}function r(){s=t}var c=this,d=+new Date-l,u=arguments;i&&!s&&o(),s&&clearTimeout(s),i===t&&d>e?o():n!==!0&&(s=setTimeout(i?r:o,i===t?e-d:e))}var s,l=0;return"boolean"!=typeof n&&(i=a,a=n,n=t),o.guid&&(r.guid=a.guid=a.guid||o.guid++),r},o.debounce=function(e,o,a){return a===t?n(e,o,!1):n(e,a,o!==!1)}}(this);
/*!
...
!function(e){if("function"==typeof define&&define.amd)define(e);else if("object"==typeof exports)module.exports=e();else{var t=window.Cookies,n=window.Cookies=e(window.jQuery);n.noConflict=function(){return window.Cookies=t,n}}}(function(){function e(){for(var e=0,t={};e<arguments.length;e++){var n=arguments[e];for(var o in n)t[o]=n[o]}return t}function t(n){function o(t,i,a){var r;if(arguments.length>1){if(a=e({path:"/"},o.defaults,a),"number"==typeof a.expires){var s=new Date;s.setMilliseconds(s.getMilliseconds()+864e5*a.expires),a.expires=s}try{r=JSON.stringify(i),/^[\{\[]/.test(r)&&(i=r)}catch(l){}return i=encodeURIComponent(String(i)),i=i.replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g,decodeURIComponent),t=encodeURIComponent(String(t)),t=t.replace(/%(23|24|26|2B|5E|60|7C)/g,decodeURIComponent),t=t.replace(/[\(\)]/g,escape),document.cookie=[t,"=",i,a.expires&&"; expires="+a.expires.toUTCString(),a.path&&"; path="+a.path,a.domain&&"; domain="+a.domain,a.secure?"; secure":""].join("")}t||(r={});for(var c=document.cookie?document.cookie.split("; "):[],d=/(%[0-9A-Z]{2})+/g,u=0;u<c.length;u++){var p=c[u].split("="),f=p[0].replace(d,decodeURIComponent),h=p.slice(1).join("=");'"'===h.charAt(0)&&(h=h.slice(1,-1));try{if(h=n&&n(h,f)||h.replace(d,decodeURIComponent),this.json)try{h=JSON.parse(h)}catch(l){}if(t===f){r=h;break}t||(r[f]=h)}catch(l){}}return r}return o.get=o.set=o,o.getJSON=function(){return o.apply({json:!0},[].slice.call(arguments))},o.defaults={},o.remove=function(t,n){o(t,"",e(n,{expires:-1}))},o.withConverter=t,o}return t()});
/*!
...
var unikat=function(){"use strict";function e(){if(p='<div tabindex="-1" class="ajax-locked"><div><div><img src="'+m.loadingImageSrc+'" alt="'+m.loadingImageAlt+'" title="'+m.loadingImageTitle+'">'+m.loadingText+"</div></div></div>",b=m.ajaxErrorMessage+b,placeholder(),!m.is_auth){window.history.location||window.location;$(window).on("popstate",function(e){var t=$(".sidebar"),n=$(".sidebar-tabs li"),a=window.location.hash,o=a?t.index($(a)):0,i=Cookies.getJSON("jsCookies");t.removeClass("sidebar-active"),n.removeClass("sidebar-tab-active"),t.eq(o).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),n.eq(o).addClass("sidebar-tab-active"),Cookies.set("jsCookies",{sidebar:o,navState:i?i.navState:null},{expires:365})}),$("#fixed-header").headroom({offset:m.headroomOffset}),$(".nav-toggle").on("click","a",function(e){e.preventDefault(),$(this).parent().toggleClass("collapsed"),$("#wrapper").toggleClass("collapsed");var t;t=$("#wrapper").hasClass("collapsed")?"collapsed":null;var n=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{navState:t,sidebar:n?n.sidebar:null},{expires:365})}),$(".sidebar-tabs").on("click","a",function(e){e.preventDefault();var t=$(this).parent(),n=$(".sidebar-tabs li"),a=$(".sidebar"),o=n.index(t);n.removeClass("sidebar-tab-active"),t.addClass("sidebar-tab-active"),a.removeClass("sidebar-active"),a.eq(o).addClass("sidebar-active").css("opacity",0).animate({opacity:1},"fast"),history.pushState(null,document.title,$(this).attr("href"));var i=Cookies.getJSON("jsCookies");Cookies.set("jsCookies",{sidebar:o,navState:i?i.navState:null},{expires:365})}),$("[id^="+g+"]").on("click",function(){$(this).attr("id").substring(g.length);$.magnificPopup.open({type:"ajax",key:"popup-form",focus:"input",closeOnBgClick:!1,tClose:m.magnificPopupClose,tLoading:m.magnificPopupLoading,ajax:{tError:m.magnificPopupAjaxError},preloader:!0,removalDelay:500,mainClass:"mfp-zoom-in",items:{src:"http://cms.laravel.local/users/admins/create"}})}),m.datatables&&($.extend($.fn.dataTable.defaults,{dom:"<'clearfix'<'dataTableL'l><'dataTableF'f>>tr<'clearfix'<'dataTableI'i><'dataTableP'p>>",paging:m.datatablesCount<=10?!1:!0,stateSave:!0,deferRender:!0,retrieve:!0,stateDuration:0,defaultContent:"",searchDelay:m.datatablesAjax?400:0,serverSide:m.datatablesAjax?!0:!1,pagingType:m.datatablesPagingType,pageLength:m.datatablesPageLength,lengthMenu:m.datatablesLengthMenu,language:{url:m.datatablesLanguage},initComplete:function(e,t){var n=$("input",e.aanFeatures.f);n.off("keyup.DT input.DT");var a=$(".dataTable").DataTable();$(document).on("input keyup",n.selector,$.debounce(e.searchDelay,function(e){a.search(this.value).draw()}))}}),$.fn.dataTable.Api.register("clearPipeline()",function(){return this.iterator("table",function(e){e.clearCache=!0})}))}$(document).on("click",function(e){$(e.target).closest(".dropdown").length||$(".dropdown-menu").each(function(){$(this).hasClass("dropdown-menu-static")||($(this).hasClass("dropdown-menu-slide")?$(this).slideUp():$(this).removeClass("open"))})}),$(document).on("click",".dropdown-toggle",function(e){e.preventDefault();var t=$(this).next();$(".dropdown-menu.open").not([".dropdown-menu-static",t[0]]).removeClass("open"),t.hasClass("dropdown-menu-slide")?t.slideToggle():t.toggleClass("open")}),$(document).on("click",P+" "+L,function(){$(this).closest(P).remove()}),"function"==typeof this.callback&&this.callback(),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$.ajax({url:m.urlGoogleAnalytics,dataType:"script",cache:!0})}function t(e,t,n){var a=e.find("input:not(:button, :submit, :reset, :radio, :checkbox, [type=hidden]), select, textarea"),o=e.find("input:radio, input:checkbox");n?(a.each(function(){$(this).is(n)&&$(this).val("")}),o.each(function(){$(this).is(n)&&$(this).removeAttr("checked").removeAttr("selected")})):t?(a.not(t).val(""),o.not(t).removeAttr("checked").removeAttr("selected")):(a.val(""),o.removeAttr("checked").removeAttr("selected"))}function n(e){return $("[type=submit]",e).prop("disabled",!0),f=window.setTimeout(function(){$(p).prependTo(e.closest(J)).focus(),$(F,e).on("keydown",function(t){t.preventDefault(),t.stopPropagation();var n=t.keyCode?t.keyCode:t.which;return 27==n&&a(e),!1})},R),!0}function a(e){return h.abort(),window.clearTimeout(f),e.prev(P).empty(),$("[type=submit]",e).prop("disabled",!1),$(F,e).remove(),!0}function o(e,t){var n=e.prev(P);n.length>0?n.append(t):($(T+t+S).insertBefore(e),n=e.prev(P)),isElementInViewport(n[0])||$.scrollTo(n[0])}function i(e){$(D,e).remove(),$(A,e).removeClass(I)}function s(e,t){i(e);var n="";if("object"==typeof t){n+=v+b;for(var a in t){$("#input-"+a).next().hasClass(M)?$("#input-"+a).after(E).closest(A).addClass(I):$("#input-"+a).closest(A).addClass(N).append(E);for(var s=0;s<t[a].length;s++)n+=y+O+t[a][s]+x}n+=C+w}o(e,n)}function r(e,n){i(e);var a="",s=[],r=[];if("object"==typeof n){if(n.errors){a+=v+b;for(var l=0;l<n.errors.length;l++)a+=y+O+n.errors[l]+x;a+=C+w}if(n.ids)for(var l=0;l<n.ids.length;l++)$("#input-"+n.ids[l]).next().hasClass(M)?$("#input-"+n.ids[l]).after(E).closest(A).addClass(I):$("#input-"+n.ids[l]).closest(A).addClass(N).append(E);if(n.resetOnly){for(var l=0;l<n.resetOnly.length;l++)r.push("#input-"+n.resetOnly[l]);r.length&&t(e,null,r.join())}else if(n.resetExcept){for(var l=0;l<n.resetExcept.length;l++)s.push("#input-"+n.resetExcept[l]);s.length&&t(e,s.join())}else n.reset&&t(e)}o(e,a)}function l(e,t){i(e),t=v+O+t+w,o(e,t)}function c(e,t){i(e),t=k+t+j,o(e,t)}function d(e){$("#"+e).submit(function(e){e.preventDefault();var o=$(this);return"undefined"!=typeof h&&a(o),n(o),h=$.post(o.attr("action"),o.serialize()),h.done(function(e,n,i){e.redirect?window.location.href=e.redirect:(a(o),e.success?(c(o,e.success),t(o)):r(o,e))}),h.fail(function(e,t,n){a(o),422==e.status?s(o,e.responseJSON):l(o,t+": "+n)}),!1})}function u(e){var e=$.extend({pipeline:m.datatablesPipeline,url:"",data:null,method:"GET"},e),o=-1,i=null,d=null,u=null;return function(p,f,m){var g=!1,v=p.start,b=p.start,y=p.length,x=v+y;if(m.clearCache?(g=!0,m.clearCache=!1):0>o||o>v||x>i?g=!0:(JSON.stringify(p.order)!==JSON.stringify(d.order)||JSON.stringify(p.columns)!==JSON.stringify(d.columns)||JSON.stringify(p.search)!==JSON.stringify(d.search))&&(g=!0),d=$.extend(!0,{},p),g){if(o>v&&(v-=y*(e.pipeline-1),0>v&&(v=0)),o=v,i=v+y*e.pipeline,p.start=v,p.length=y*e.pipeline,$.isFunction(e.data)){var C=e.data(p);C&&$.extend(p,C)}else $.isPlainObject(e.data)&&$.extend(p,e.data);var w=$(this).closest(J);"undefined"!=typeof h&&a(w),n(w),h="GET"==e.method?$.get(e.url,p):$.post(e.url,p),h.done(function(e,n,i){e.redirect?window.location.href=e.redirect:(a(w),e.success?(c(w,e.success),t(w)):e.errors?r(w,e):(u=$.extend(!0,{},e),o!=b&&e.data.splice(0,b-o),e.data.splice(y,e.data.length),f(e)))}),h.fail(function(e,t,n){a(w),422==e.status?s(w,e.responseJSON):l(w,t+": "+n)})}else{var k=$.extend(!0,{},u);k.draw=p.draw,k.data.splice(0,v-o),k.data.splice(y,k.data.length),f(k)}}}var p,f,h,m={},g="js-create-",v='<div class="alert alert-danger alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button>',b="<ul>",y="<li>",x="</li>",C="</ul>",w="</div>",k='<div class="alert alert-success alert-dismissible"><button type="button" class="close"><span aria-hidden="true">&times;</span></button><span class="glyphicon glyphicon-ok"></span>',j="</div>",T='<div class="alert-messages">',S="</div>",O='<span class="glyphicon glyphicon-warning-sign"></span>',E='<span class="glyphicon glyphicon-remove form-control-feedback"></span>',D="span.glyphicon-remove",A=".form-group",N="has-error has-feedback",I=N+" has-addon-feedback",J=".ajax-lock",F=".ajax-locked",P=".alert-messages",M="input-group-addon",L="button.close",R=0;return{ajax_submit:d,datatables:u,run:e,variables:m}}();
